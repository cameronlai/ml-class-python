...
if __name__ == "__main__":
    ...
    regr = linear_model.Ridge(alpha=alpha, max_iter=iterations, solver='sag', normalize=True)
    # ===========================================
    ...
    regr = linear_model.Ridge(alpha=alpha, max_iter=iterations, solver='svd')
    # ===========================================
